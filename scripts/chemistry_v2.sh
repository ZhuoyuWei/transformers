...
--decoder_version=v2 --encoder_model_name_or_path=/data/zhuoyu/semantic_parsing_v2/bertmodels --decoder_model_name_or_path=/data/zhuoyu/semantic_parsing_v2/bertmodels
