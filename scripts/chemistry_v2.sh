...
--decoder_version=v2 --encoder_model_name_or_path=/data/zhuoyu/semantic_parsing_v2/bertmodels/encoder \
--decoder_model_name_or_path=/data/zhuoyu/semantic_parsing_v2/bertmodels/decoder --encoder_lr=$2 --decoder_lr=$2 --decoding_type=decoding
